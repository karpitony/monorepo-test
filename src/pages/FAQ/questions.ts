...
export const questions: Questions = {
  '공통': [
    {
      ...
      answer: `동국대학교 학부생이라면 신입생, 재학생, 휴학생 관계없이 지원 가능해요. 
      단, 대학원생의 경우 학부 Farm 활동에 제약이 있습니다. 대학원 Farm에 도전해보세요!`
    },
    {
    ...
    },
    {
      ...
      answer: '총 5개의 트랙은 각 트랙별로 운영진 및 지도교수님이 담당해주시고 계십니다. 트랙별로 커리큘럼 및 운영방식이 다르기 때문에 트랙 소개를 참고해주세요.'
    },
    {
      question: 'Farm System에서 어떤 활동을 하게 되나요?',
      answer: 'Farm System에서는 아이디어톤, 해커톤, 이달의 세미나, 부스 운영(전시회) 등 다양한 활동을 진행합니다. 또한 트랙별 프로젝트를 수행하며, 실무 환경과 유사한 협업 경험을 쌓을 수 있어요.'
    },
    {
    ...
    },
    {
      ...
      answer: '동국대학교 공식 비교과 과정으로 선정된 FarmSystem의 운영비는 모두 학교에서 지원됩니다. 따라서 회비는 없습니다.'
    },
    {
  ...
  '보안/웹': [
    ...
    {
      question: '개발 경험이 없어도 지원할 수 있나요?',
      answer: '네! 웹 개발과 보안에 관심이 있다면 기초부터 배울 수 있습니다. 기초 프로그래밍 지식이 있다면 더 좋지만, 트랙 내 자율 스터디 및 세미나를 통해 체계적으로 학습할 수 있습니다.'
    },
    {
      question: '트랙에서 진행하는 프로젝트는 어떤 방식으로 운영되나요?',
      answer: '트랙에서는 학기별로 보안 및 웹 개발 프로젝트를 수행합니다. 1차 프로젝트에서는 국내 보안 학회 논문을 기반으로 주제를 도출하고, 2차 프로젝트에서는 기업과 연계하여 실제 산업에서 요구하는 보안 기술을 적용합니다.'
    },
    {
